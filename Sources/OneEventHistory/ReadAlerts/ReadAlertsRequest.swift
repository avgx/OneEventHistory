...
/// Request body for `EventHistoryService.ReadAlerts`.
public struct ReadAlertsRequest: Encodable, Sendable {
    public let range: TimeRange
    public let filters: AlertsSearchFilterArray
    ...
    public init(
        range: TimeRange,
        filters: AlertsSearchFilterArray,
        limit: Int? = nil,
        offset: Int? = nil,
